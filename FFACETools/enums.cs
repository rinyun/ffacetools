namespace FFACETools
{
	...
	public enum Zone : short
	{
		...
		Diorama Abdhaljs_Ghelsba = 0x2B,
		Abdhaljs_Isle_Purgonorgo = 0x2C,
		Open_sea_route_to_Al_Zahbi = 0x2E,
		Open_sea_route_to_Mhaura = 0x2F
		Al_Zahbi = 0x30,
		...
		Halvung = 0x3E,
		Lebros_Cavern = 0x3F,
		Navukgo_Execution_Chamber = 0x40,
		Mamook = 0x41,
		Mamool_Ja_Training_Grounds = 0x42,
		Jade_Sepulcher = 0x43,
		Aydeewa_Subterrane = 0x44,
		Leujaoam_Sanctum = 0x45,
		Chocobo_Circuit = 0x46,
		The_Colosseum = 0x47,
		Alzadaal_Undersea_Ruins = 0x48,
		Zhayolm_Remnants = 0x49,
		Arrapago_Remnants = 0x4A,
		Bhaflau_Remnants = 0x4B,
		Silver_Sea_Remnants = 0x4C,
		Nyzul_Isle = 0x4D,
		Hazhalm_Testing_Grounds = 0x4E,
		Caedarva_Mire = 0x4F,
		Southern_San_DOria_[S] = 0x50,
		East_Ronfaure_[S] = 0x51,
		Jugner_Forest_[S] = 0x52,
		Vunkerl_Inlet_[S] = 0x53,
		Batallia_Downs_[S] = 0x54,
		La_Vaule_[S] = 0x55,
		Everbloom_Hollow = 0x56,
		Bastok_Markets_[S] = 0x57,
		North_Gustaberg_[S] = 0x58,
		Grauberg_[S] = 0x59,
		Pashhow_Marshlands_[S] = 0x5A,
		Rolanberry_Fields_[S] = 0x5B,
		Beadeaux_[S] = 0x5C,
		Ruhotz_Silvermines = 0x5D,
		Windurst_Waters_[S] = 0x5E,
		West_Sarutabaruta_[S] = 0x5F,
		Fort_Karugo_Narugo_[S] = 0x60,
		Meriphataud_Mountains_[S] = 0x61,
		Sauromugue_Champaign_[S] = 0x62,
		Castle_Oztroja_[S] = 0x63,
		Ronfaure_West = 0x64,
		Ronfaure_East = 0x65,
		...
		Beaucedine_Glacier_[S] = 0x88,
		Xarcabard_[S] = 0x89,
		Castle_Zvahl_Baileys_[S] = 0x8A,
		Horlais_Peak = 0x8B,
		...
		Chamber_of_Oracles = 0xA8,
		Toraimarai_Canal = 0xA9,
		Full_Moon_Fountain = 0xAA,
		Crawlers_Nest_[S] = 0xAB,
		Zeruhn_Mines = 0xAC,
		Korroloka_Tunnel = 0xAD,
		Kuftal_Tunnel = 0xAE,
		The_Eldieme_Necropolis_[S] = 0xAF,
		Sea_Serpent_Grotto = 0xB0,
		VeLugannon_Palace = 0xB1,
		Shrine_of_RuAvitau = 0xB2,
		Stellar_Fulcrum = 0xB3,
		LaLoff_Amphitheatre = 0xB4,
		The_Celestial_Nexus = 0xB5,
		Walk_of_Echoes = 0xB6,
		The_Last_Stand = 0xB7,
		Delkfutts_Lower_Tower = 0xB8,
		Dynamis_San_DOria = 0xB9,
		Dynamis_Bastok = 0xBA,
		Dynamis_Windurst = 0xBB,
		Dynamis_Jeuno = 0xBC,
		King_Ranperres_Tomb = 0xBE,
		Dangruf_Wadi = 0xBF,
		Horutoto_Inner_Ruins = 0xC0,
		Ordelles_Caves = 0xC1,
		Outer_Horutoto_Ruins = 0xC2,
		...
		Airship_from_San_DOria_to_Jeuno = 0xDF,
		...
		Port_Bastok = 0xEC,
		Metalworks = 0xED,
		Windurst_Waters = 0xEE,
		Windurst_Walls = 0xEF,
		Port_Windurst = 0xF0,
		Windurst_Woods = 0xF1,
		Heavens_Tower = 0xF2,
		Ru_Lude_Gardens = 0xF3,
		Upper_Jeuno = 0xF4,
		Lower_Jeuno = 0xF5,
		Port_Jeuno = 0xF6,
		Rabao = 0xF7,
		...
		Bastok Residential Area = 0xFE,
		Windurst Residential Area = 0xFF
