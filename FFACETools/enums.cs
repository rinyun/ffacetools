namespace FFACETools
{
    ...
    public enum Zone : short
    {
        ...
        Caedarva_Mire = 0x4F,
        Southern_San_DOria_S = 0x50,
        East_Ronfaure_S = 0x51,
        Jugner_Forest_S = 0x52,
        Vunkerl_Inlet_S = 0x53,
        Batallia_Downs_S = 0x54,
        La_Vaule_S = 0x55,
        Everbloom_Hollow = 0x56,
        Bastok_Markets_S = 0x57,
        North_Gustaberg_S = 0x58,
        Grauberg_S = 0x59,
        Pashhow_Marshlands_S = 0x5A,
        Rolanberry_Fields_S = 0x5B,
        Beadeaux_S = 0x5C,
        Ruhotz_Silvermines = 0x5D,
        Windurst_Waters_S = 0x5E,
        West_Sarutabaruta_S = 0x5F,
        Fort_Karugo_Narugo_S = 0x60,
        Meriphataud_Mountains_S = 0x61,
        Sauromugue_Champaign_S = 0x62,
        Castle_Oztroja_S = 0x63,
        Ronfaure_West = 0x64,
        Ronfaure_East = 0x65,
        ...
        Beaucedine_Glacier_S = 0x88,
        Xarcabard_S = 0x89,
        Castle_Zvahl_Baileys_S = 0x8A,
        Horlais_Peak = 0x8B,
        ...
        Crawlers_Nest_S = 0xAB,
        Zeruhn_Mines = 0xAC,
        Korroloka_Tunnel = 0xAD,
        Kuftal_Tunnel = 0xAE,
        The_Eldieme_Necropolis_S = 0xAF,
